...
import com.prgmtc.keymatrix.vista.per.pnModifReg;
...
public class pnBusModif extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pnBoton = new javax.swing.JPanel();
        ...
        jScrollPane1.setBounds(0, 0, 800, 360);

        pnBoton.setBackground(new java.awt.Color(0, 213, 245));
        pnBoton.setForeground(new java.awt.Color(3, 7, 71));
        pnBoton.setLayout(null);

        btnModificar.setFont(new java.awt.Font("Roboto Light", 1, 18)); // NOI18N
        btnModificar.setForeground(new java.awt.Color(3, 7, 71));
        ...
        pnBoton.add(btnModificar);
        btnModificar.setBounds(0, 0, 190, 40);

        pnlDatos.add(pnBoton);
        pnBoton.setBounds(590, 370, 190, 40);
    ...
    private void btnModificarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModificarMouseEntered
        // TODO add your handling code here:
        pnBoton.setBackground(new java.awt.Color(3,7,71));
    ...
    private void btnModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModificarMouseClicked
        // TODO add your handling code here:
        int idPer = Integer.parseInt(tblDatos.getValueAt(tblDatos.getSelectedRow(), 0).toString());
        pnModifReg pnr = new pnModifReg(idPer);
        pnr.setSize(834, 540);
        this.jPanel1.removeAll();
        this.jPanel1.add(pnr);
    ...
    private javax.swing.JPanel pnBoton;
