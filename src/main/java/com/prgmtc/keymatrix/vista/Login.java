...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        logoname1.setBackground(new java.awt.Color(0, 0, 0));
        logoname1.setFont(new java.awt.Font("Roboto Medium", 0, 24)); // NOI18N
        logoname1.setForeground(new java.awt.Color(255, 255, 255));
        logoname1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        logoname1.setText("Ciencias de la Educación");
        bg.add(logoname1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 30, 290, 20));

        citybg.setBackground(new java.awt.Color(0, 134, 190));
        citybg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/EdifUSB.png"))); // NOI18N
        ...
        favicon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/logoUSB2.png"))); // NOI18N
        bg.add(favicon, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 90, 80));
        ...
        loginBtn.setBackground(new java.awt.Color(249, 164, 39));

        loginBtnTxt.setBackground(new java.awt.Color(249, 164, 39));
        loginBtnTxt.setFont(new java.awt.Font("Roboto Condensed", 1, 14)); // NOI18N
        loginBtnTxt.setForeground(new java.awt.Color(0, 51, 153));
        ...
        bg.add(loginBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 410, 130, 40));
    ...
    private void loginBtnTxtMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseExited
        loginBtn.setBackground(new Color(249,164,39));
